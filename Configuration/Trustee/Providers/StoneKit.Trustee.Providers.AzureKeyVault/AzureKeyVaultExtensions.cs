...
//                    var secrets = await _secretClient.GetPropertiesOfSecretsAsync().ToListAsync(cancellationToken);

//                    foreach (var secret in secrets)
//                    {
//                        var currentVersion = _secretVersions.GetValueOrDefault(secret.Name);
...
//            _logger.LogInformation("Listing paths at {VaultUri}", _providerOptions.VaultUri);

//            var secrets = await _secretClient.GetPropertiesOfSecretsAsync().ToListAsync();
