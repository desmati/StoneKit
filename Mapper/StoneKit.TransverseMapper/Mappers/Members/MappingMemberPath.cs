...
{
    /// <summary>
    /// Represents a path of mapping members between source and target types.
    /// </summary>
    internal sealed class MappingMemberPath
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MappingMemberPath"/> class with a list of source and target members.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MappingMemberPath"/> class with a single source and target member.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MappingMemberPath"/> class with a single source and target member and a specified type pair.
        /// </summary>
        /// <param name="source">The source member in the path.</param>
        /// <param name="target">The target member in the path.</param>
        /// <param name="typePair">The type pair associated with the source and target members.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MappingMemberPath"/> class with a list of source and target members and a specified type pair.
        /// </summary>
        /// <param name="source">The list of source members in the path.</param>
        /// <param name="target">The list of target members in the path.</param>
        /// <param name="typePair">The type pair associated with the source and target members.</param>
        ...
        /// <summary>
        /// Gets a value indicating whether the source path has only one level.
        /// </summary>
        public bool OneLevelSource { get; }

        /// <summary>
        /// Gets a value indicating whether the target path has only one level.
        /// </summary>
        ...
        /// <summary>
        /// Gets the type pair associated with the source and target members.
        /// </summary>
        public TypePair TypePair { get; }

        /// <summary>
        /// Gets the tail mapping member in the path.
        /// </summary>
        public MappingMember Tail { get; }

        /// <summary>
        /// Gets the head mapping member in the path.
        /// </summary>
