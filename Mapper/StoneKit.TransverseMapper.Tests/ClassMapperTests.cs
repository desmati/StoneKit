...
namespace StoneKit.TransverseMapper.Tests
{
    public sealed class ClassMapperTests
    {
        ...
        public void Map_PrimitiveField_Success()
        {
            ...
            MapperBase mapper = builder.Build(new TypePair(typeof(SourceWithFields), typeof(TargetWithFields)));
        ...
        {
            var builder = new ClassMapperBuilder(new MapperCache(), new MappingBuilderConfigStub());
            MapperBase mapper = builder.Build(new TypePair(typeof(SourceWithProperties), typeof(TargetWithProperties)));
