...
namespace UnitTests.Mappings.Attributes
{
    public sealed class MappingWithAttributesTests
    {
        ...
        {
            Transverse.Bind<SourceWithIgnore, TargetWithIgnore>();

            SourceWithIgnore source = CreateSourceWithIgnore();
            var actual = Transverse.Map<TargetWithIgnore>(source);
        ...
        {
            Transverse.Bind<SourceWithSubset, TargetSubset1>();
            Transverse.Bind<SourceWithSubset, TargetSubset2>();

            SourceWithSubset source = CreateSourceWithSubset();
            var target1 = Transverse.Map<TargetSubset1>(source);
            ...
            var target2 = Transverse.Map<TargetSubset2>(source);
