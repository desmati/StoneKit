...
namespace StoneKit.TransverseMapper.Tests.Mappings
{
    public sealed class MappingWithConfigTests
    {
        ...
        {
            Transverse.Bind<SourceItem, TargetItem>();

            Transverse.Bind<Source1, Target1>(config =>
            {
        ...
        {
            Transverse.Bind<Source2, Target2>(config =>
            {
        ...
        {
            Transverse.Bind<SourceName, TargetName>(config =>
            {
                config.Bind(s => s.CName, t => t.C2Name1);
                config.Bind(s => s.CName, t => t.C2Name2);
            });

            var result = Transverse.Map<TargetName>(new SourceName
            {
                CName = "7788"
            });
