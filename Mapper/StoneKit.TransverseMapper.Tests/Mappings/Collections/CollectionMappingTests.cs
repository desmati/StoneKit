...
namespace UnitTests.Mappings.Collections
{
    public sealed class CollectionMappingTests
    {
        ...
        {
            Transverse.Bind<Source1, Target1>();
            ...
            var actual = Transverse.Map<Target1>(source);
        ...
        public void Map_DifferentCollections_Success()
        {
            ...
            var actual = Transverse.Map<PersonDto>(source);
        ...
        {
            Transverse.Bind<Source3, Target3>();
            ...
            var actual = Transverse.Map<Target3>(source);
        ...
        public void Map_NullCollection_Success()
        {
            ...
            Transverse.Bind<Source2, Target2>();

            var actual = Transverse.Map<Target2>(source);
        ...
        public void Map_IEnumerable_T_Success()
        {
            ...
            Transverse.Bind<PersonComplex, PersonComplexTarget>();

            var actual = Transverse.Map<PersonComplexTarget>(target);
        ...
        public void Map_IEnumerable_Success()
        {
            ...
            Transverse.Bind<PersonComplex, PersonComplexTarget2>();

            var actual = Transverse.Map<PersonComplexTarget2>(target);
        ...
        public void Map_To_IEnumerable_T_Success()
        {
            ...
            Transverse.Bind<PersonComplex3, PersonComplexTarget3>();

            var actual = Transverse.Map<PersonComplexTarget3>(target);
        ...
        public void Map_To_IEnumerable_Success()
        {
            ...
            Transverse.Bind<PersonComplex, PersonComplexTarget4>();

            var actual = Transverse.Map<PersonComplexTarget4>(target);
