...
namespace StoneKit.TransverseMapper.Tests.Mappings.Collections
{
    public sealed class DictionaryMappingTests
    {
        ...
        public void Map_Dictionary_Success()
        {
            ...
            var target = Transverse.Map<Target1>(source);
        ...
        public void Map_IDictionary_Success()
        {
            ...
            var target = Transverse.Map<Target3>(source);
        ...
        {
            Transverse.Bind<Source1, Target3>();
        ...
        {
            Transverse.Bind<ItemKeySource, ItemKeyTarget>();
            ...
            var target = Transverse.Map<Target2>(source);
