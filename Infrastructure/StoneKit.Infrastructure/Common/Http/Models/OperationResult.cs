...
{
    public const string DEFAULT_SUCCESS_MESSAGE = "Action successfully completed.";
    public const string DEFAULT_FAILUE_MESSAGE = "Action Failed!";
    public const string DEFAULT_NOT_FOUND_MESSAGE = "Item(s) not found.";
    public const string DEFAULT_UNAUTHORIZED_MESSAGE = "Unauthorized, this action restricted to owner/admin users.";
    public const string DEFAULT_DELETED_MESSAGE = "Item(s) deleted successfully.";

    public OperationStatusCodes StatusCode { get; protected set; } = OperationStatusCodes.InternalServerError;
    public string ErrorCode => StatusCode.ToString();
    public bool Succeed { get; protected set; } = false;
    public bool Failed => !Succeed;
    public string Message { get; protected set; } = DEFAULT_FAILUE_MESSAGE;
    public List<string> Warnings { get; protected set; } = [];

    public OperationResult Success(string message = DEFAULT_SUCCESS_MESSAGE, OperationStatusCodes statusCode = OperationStatusCodes.OK, List<string>? warnings = null)
    {
        Message = message;
        Succeed = true;
    ...
    public OperationResult Failure(string message = DEFAULT_FAILUE_MESSAGE, OperationStatusCodes statusCode = OperationStatusCodes.InternalServerError)
    {
        Message = message;
        Succeed = false;
        StatusCode = statusCode;
    ...
    public OperationResult Decide(bool? didSucceed = null, string message = null!)
    {
        return didSucceed ?? Succeed
            ? Success(message ?? DEFAULT_SUCCESS_MESSAGE)
            : Failure(message ?? DEFAULT_FAILUE_MESSAGE);
    }
    ...
    public OperationResult ItemNotFound(string message = DEFAULT_NOT_FOUND_MESSAGE)
    {
        Message = message;
        Succeed = false;
    ...
    public OperationResult DeletedSuccessfully(string message = DEFAULT_DELETED_MESSAGE)
    {
        Message = message;
        Succeed = true;
        StatusCode = OperationStatusCodes.OK;

        return this;
    }


    public OperationResult Unauthorized(string message = DEFAULT_UNAUTHORIZED_MESSAGE)
    {
        Message = message;
        Succeed = false;
        StatusCode = OperationStatusCodes.Unauthorized;
...
{
    public TContent? Data { get; private set; } = default;

    public OperationResult<TContent> Success(TContent? data, string? message = DEFAULT_SUCCESS_MESSAGE, OperationStatusCodes statusCode = OperationStatusCodes.OK, List<string>? warnings = null)
    {
    ...
    public OperationResult<TContent> Failure(string? message = null, List<string>? warnings = null, TContent? data = default)
    {
        Message = message ?? DEFAULT_FAILUE_MESSAGE;
        Data = data;
        Succeed = false;
        StatusCode = OperationStatusCodes.InternalServerError;
        Warnings = warnings ?? [];

        return this;
    }
    
    public OperationResult<TContent> AddFriendlyException(ApiException? apiException)
    {
        Message = apiException?.GetExceptionMessages() ?? DEFAULT_FAILUE_MESSAGE;
        Data = default;
        Succeed = false;
        StatusCode = OperationStatusCodes.OK;
    ...
    public OperationResult<TContent> AddException(Exception? exception)
    {
        Message = exception?.GetExceptionMessages() ?? DEFAULT_FAILUE_MESSAGE;
        Data = default;
        Succeed = false;
        StatusCode = OperationStatusCodes.InternalServerError;
    ...
    public new OperationResult<TContent> ItemNotFound(string message = DEFAULT_NOT_FOUND_MESSAGE)
    {
        Message = message;
        Succeed = false;
        StatusCode = OperationStatusCodes.NotFound;
    ...
    public new OperationResult<TContent> DeletedSuccessfully(string message = DEFAULT_DELETED_MESSAGE)
    {
        if (message == DEFAULT_DELETED_MESSAGE)
        {
            var type = typeof(TContent);
            Message = $"{type.Name}() deleted successfully";
        }
    ...
    public new OperationResult<TContent> Unauthorized(string message = DEFAULT_UNAUTHORIZED_MESSAGE)
    {
        Message = message;
        Succeed = false;
    ...
    public OperationResult<TContent> Decide(bool? didSucceed = null, TContent? data = default, string message = null!)
    {
        return didSucceed ?? Succeed
            ? Success(data, message ?? DEFAULT_SUCCESS_MESSAGE)
            : Failure(message ?? DEFAULT_FAILUE_MESSAGE, [], data);
    }
